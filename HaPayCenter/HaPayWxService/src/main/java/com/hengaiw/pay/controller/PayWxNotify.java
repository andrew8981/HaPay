 ...
 */
@RestController
public class PayWxNotify extends PayNotifyBase {

	private static final HaLog _log = HaLog.getLog(PayWxNotify.class);
	...
	public boolean verifyWxPayParams(Map<String, Object> payContext) {
		...
		//校验结果是否成功
		if (!PayConstants.RETURN_VALUE_SUCCESS.equalsIgnoreCase(params.getResultCode())
				|| !PayConstants.RETURN_VALUE_SUCCESS.equalsIgnoreCase(params.getResultCode())) {
