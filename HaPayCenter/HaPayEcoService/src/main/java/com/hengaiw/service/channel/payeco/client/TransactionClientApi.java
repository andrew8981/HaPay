...
public class TransactionClientApi {
     ...
     */
    public static String MerchantOrderPayQuickByAcc(String merchantId, String industryId, 
    		String merchOrderId, String amount, String orderDesc, String tradeTime, 
    		String expTime, String notifyUrl, String extData, String miscData, String notifyFlag, 
            String mercPriKey, String payecoPubKey, String payecoUrl, Xml retXml) throws Exception {
		//交易参数
		String tradeCode = "PayQuickByAcc";
