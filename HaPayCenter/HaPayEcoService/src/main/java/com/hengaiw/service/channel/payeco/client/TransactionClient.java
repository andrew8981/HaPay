...
public class TransactionClient {
	...
	public static String OrderRefundReq(String merchantId, String merchOrderId, String merchRefundId, 
		...
		String retMerchantId = PayEcoTools.getXMLValue(retStr, "MerchantId");
		String retMerchOrderId = PayEcoTools.getXMLValue(retStr, "MerchOrderId");
		String retMerchRefundId = PayEcoTools.getXMLValue(retStr, "MerchRefundId");
		String retAmount = PayEcoTools.getXMLValue(retStr, "Amount");
		String retTsNo = PayEcoTools.getXMLValue(retStr, "TsNo");
		String retTradeTime = PayEcoTools.getXMLValue(retStr, "TradeTime");
		String retSign = PayEcoTools.getXMLValue(retStr, "Sign");
		//设置返回数据
		retXml.setTradeCode(tradeCode);
	...
	public static String OrderRefundQuery(String merchantId, String merchOrderId, String merchRefundId, 
		...
		String retTsNo = PayEcoTools.getXMLValue(retStr, "TsNo");	
		String retStatus = PayEcoTools.getXMLValue(retStr, "Status");	
		String retRefundTime = PayEcoTools.getXMLValue(retStr, "RefundTime");	
		String retSettleDate = PayEcoTools.getXMLValue(retStr, "SettleDate");	
	...
	public static String UnboundBankCard(String merchantId, String bankAccNo, String tradeTime, 
		...
		String retVer = PayEcoTools.getXMLValue(retStr, "Version");
		String retMerchantId = PayEcoTools.getXMLValue(retStr, "MerchantId");
		String retBankAccNo = PayEcoTools.getXMLValue(retStr, "BankAccNo");
		String retTradeTime = PayEcoTools.getXMLValue(retStr, "TradeTime");
		String retStatus = PayEcoTools.getXMLValue(retStr, "Status");
		String retSign = PayEcoTools.getXMLValue(retStr, "Sign");
		//设置返回数据
