...
public class Mq4PayNotify {
    ...
    public void send(String msg, long delay) {
        _log.info("发送MQ延时消息:queue={},msg={},delay={}",this.payNotifyQueue, msg, delay);
